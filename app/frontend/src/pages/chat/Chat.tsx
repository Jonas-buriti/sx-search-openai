                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <SparkleFilled fontSize={"120px"} primaryFill={"rgba(0,90,210,1)"} aria-hidden="true" aria-label="Chat logo" />
                            <h1 className={styles.chatEmptyStateTitle}>Converse com seus dados</h1>
                            <h3 className={styles.chatEmptyStateSubtitle}>Faça qualquer pergunta ou tente um exemplo</h3>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput clearOnSend placeholder="Digite uma pergunta" disabled={isLoading} onSend={question => makeApiRequest(question)} />
                    </div>
                </div>
